             ...
             <b-row>
                <b-col md="6" sm="12">
                    ...
                    <b-form-input v-else id="category-parentId" type="text" v-model="category.path" readonly />
                     ...
                     <b-form-group label="Acesso Menu:" label-for="category-acessoMenu">
                        <b-form-input id="category-acessoMenu" type="text"
                            v-model="category.acessoMenu" required
                            :readonly="mode === 'remove'"
                            placeholder="" />
                    </b-form-group>
                </b-col>
    ...
    methods: {
        ...
        loadCategory(category, mode = 'save') {
            ...
            this.category = { 
               ...
               acessoMenu: category.acessoMenu
             }
        }
    },
    mounted() {
